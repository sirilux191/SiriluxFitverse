...
export default function UploadContent() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const result = await dataAsset.uploadDataAsset(emptyDataAsset);
      let uniqueID = "";
      ...
      const encryptedKeyResult =
        await dataAsset.getEncryptedSymmetricKeyForAsset(
          uniqueID,
      ...
      const pkBytesHex =
        await dataAsset.getSymmetricKeyVerificationKey(uniqueID);
      ...
      const updateResult = await dataAsset.updateDataAsset(uniqueID, dataAsset);
